...
NOTA: en caso de querer utilizar el servidor para transferir otros archivos, se debera crea o mover el archivo que se desea transferir a la carpeta de Servidor.
